...
class Ui_SearchDialog(object):
    def setupUi(self, SearchDialog):
        ...
        self.selection = QtWidgets.QListWidget(SearchDialog)
        self.selection.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        ...
        SearchDialog.setTabOrder(self.add_basket_btn, self.add_window_btn)
