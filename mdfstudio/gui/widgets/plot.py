...
""" Edit history
    ...
    fucntons
    --------
    *   export_csv :    Add keyword 'group_by'
...
class ExportDialog(exportDialog.ExportDialog):
    ...
    def copyClicked(self):
        ...
        elif self.currentExporter.Name == 'CSV from plot data':
            self.copy_clipboard_request.emit([self.min, self.max])
        else:
